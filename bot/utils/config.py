...
BOT_TOKEN_3 = os.getenv("BOT_TOKEN_3", "5804794734:AAGKSdnvSb6jQvZAgNelOK4_QyXltCUr-Xw")
...
MAIN_CHANNEL_3 = os.getenv("MAIN_CHANNEL_3", "Channel_No_3")
...
SHORTENER_API_3 = os.environ.get("SHORTENER_API_3", "ad8a6831ccccdcad18b9b59899f463fae273592e")
...
SHORTENER_WEB_3 = os.environ.get("SHORTENER_WEB_3", "https://linkshortify.com/api?api={0}&url={1}")
